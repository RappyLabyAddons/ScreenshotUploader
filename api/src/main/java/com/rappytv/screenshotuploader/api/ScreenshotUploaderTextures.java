...
public class ScreenshotUploaderTextures {
    ...
    public static class SpriteUploaders {
        ...
        public static Icon IMAGE_SERVER = Icon.sprite32(TEXTURE, 1, 1);
        public static Icon IMGUR = Icon.sprite32(TEXTURE, 2, 1);
        public static Icon XBACKBONE = Icon.sprite32(TEXTURE, 3, 1);
        public static Icon ZIPLINE = Icon.sprite32(TEXTURE, 0, 2);
    }
