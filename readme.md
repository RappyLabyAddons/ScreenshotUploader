...
3. It should open your Labymod addon directory; Paste the [Uploader.jar](https://github.com/RappyLabyAddons/Screenshot-Uploader/releases/latest/download/Uploader.jar) in there.
4. Launch your Labymod client.

If you have any problems with the addon/have update ideas, feel free to
- Open an Issue [here](https://github.com/RappyLabyAddons/Screenshot-Uploader/issues/new/choose)
  or
